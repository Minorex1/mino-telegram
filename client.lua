...
function TogglePost(name)
    ...
    TriggerServerEvent('mino-telegram:check_inbox', GetPlayers())
end
...
RegisterNUICallback('getview', function(data)
    TriggerServerEvent('mino-telegram:getTelegram', tonumber(data.id))
end)

RegisterNUICallback('sendTelegram', function(data)
    TriggerServerEvent('mino-telegram:SendTelegram', data)
end)

RegisterNUICallback('delete', function(data)
    TriggerServerEvent("mino-telegram:DeleteTelegram", tonumber(data.id))
end)
